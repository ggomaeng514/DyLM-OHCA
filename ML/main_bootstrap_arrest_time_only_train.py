...
def main(args):
    ...
    tr_bow_df = pd.read_csv(os.path.join(args.bow_dir,'tf_idf_only_train_new.csv'), index_col='id')
    va_bow_df = pd.read_csv(os.path.join(args.bow_dir,'stacked_valid_tf_idf_mecab.csv'), index_col='s_id')
    te_bow_df = pd.read_csv(os.path.join(args.bow_dir,'stacked_test_tf_idf_mecab.csv'), index_col='s_id')
    ...
    #     # '{}/best_max_{}_w{}_{}.sav'.format(PRJ_DIR, modelname, window_size, 'max')
    #     filename = f'{PRJ_DIR}storage/benchmarks/best_{modelname}_w{args.window_size}_{args.method}.sav'#/mnt/storage/personal/myhwang/NLP/experiments_results/Topic_model/stage2/secondary_tf_idf_sc_storage/benchmarks
    ...
    #                                  index=test_index)
    #     prediction_df.to_csv('{}storage/results/{}_w{}_{}_model_prediction_{}.csv'.format(args.save_dir, args.method, args.window_size, modelname, now.strftime('%Y-%m-%d_%H:%M:%S')))
    ...
    #     calc_metric_result_df.to_csv('{}storage/results/{}_w{}_{}_calc_metric_results_{}.csv'.format(args.save_dir, args.method, args.window_size, modelname, now.strftime('%Y-%m-%d_%H:%M:%S')), index=False)
    ...
    #     result_df.to_csv('{}storage/results/{}_w{}_{}_model_seq_prediction_{}.csv'.format(args.save_dir, args.method, args.window_size, modelname, now.strftime('%Y-%m-%d_%H:%M:%S')))
    ...
    #     sampled_ids = rng.choice(ids, size=int(len(ids) * sample_rate), replace=False)
    #     # 샘플링된 id와 같은 id를 가진 행만 추출
    #     X_te_ = X_te[X_te['id'].isin(sampled_ids)]
    #     Y_te_ = BN_Y_te[BN_Y_te.index.isin(sampled_ids)]
    #     X_te_id_ = X_te_id[X_te_id.isin(sampled_ids)]
    ...
    #     for m_idx, modelname in enumerate(benchmark_list):
    #         filename = f'best_{modelname}_w{args.window_size}_{args.method}.sav'
    #         benchmarks[modelname] = pickle.load(open(filename, 'rb'))
    #         # # # threshold Recall 기준 임의 설정
    ...
    # if args.save_dir is None:
    #     final_result_df.to_csv('{}storage/benchmarks/results/results_ML_w{}_{}_{}.csv'.format(PRJ_DIR, args.windw_size, args.method, now.strftime('%Y-%m-%d_%H:%M:%S')))
        
    # else:
    #     print(f'saving in {args.save_dir}')
    #     final_result_df.to_csv('{}storage/results/results_ML_w{}_{}_{}.csv'.format(args.save_dir, args.windw_size, args.method, now.strftime('%Y-%m-%d_%H:%M:%S')))
...
#2way window 0 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --training --label 'label1' --mode '2way' --window_size 0 --method 'max'

#2way window 0 average
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --training --label 'label1' --mode '2way' --window_size 0 --method 'average'

#2way window 3 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --training --label 'label1' --mode '2way' --window_size 3 --method 'max'

#2way window 3 average
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --training --label 'label1' --mode '2way' --window_size 3 --method 'average'

#3way window 0 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --training --label 'label1' --mode '3way' --window_size 0 --method 'max'

#3way window 0 average
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --training --label 'label1' --mode '3way' --window_size 0 --method 'average'

#3way window 3 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --training --label 'label1' --mode '3way' --window_size 3 --method 'max'

#3way window 3 average
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --training --label 'label1' --mode '3way' --window_size 3 --method 'average'
...
#2way window 0 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --label 'label1' --mode '2way' --window_size 0 --method 'max'

#2way window 0 average
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --label 'label1' --mode '2way' --window_size 0 --method 'average'

#2way window 3 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --label 'label1' --mode '2way' --window_size 3 --method 'max'

#2way window 3 average
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_2way --label 'label1' --mode '2way' --window_size 3 --method 'average'

#3way window 0 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --label 'label1' --mode '3way' --window_size 0 --method 'max'

#3way window 0 average
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --label 'label1' --mode '3way' --window_size 0 --method 'average'

#3way window 3 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --label 'label1' --mode '3way' --window_size 3 --method 'max'

#3way window 3 average
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_sc_bs_3way --label 'label1' --mode '3way' --window_size 3 --method 'average'
...
#2way window 0 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=5 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_mecab_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_mecab_sc_bs_2way --training --label 'label1' --mode '2way' --window_size 0 --method 'max'

#2way window 3 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=10 python main_bootstrap_arrest_time.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_mecab_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_mecab_sc_bs_2way --training --label 'label1' --mode '2way' --window_size 3 --method 'max'
...
#2way window 0 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=5 python main_bootstrap_arrest_time_only_train.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_mecab_new_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_mecab_new_sc_bs_2way --training --label 'label1' --mode '2way' --window_size 0 --method 'max'

#2way window 3 max
#CUDA_VISIBLE_DEVICES=4 OMP_NUM_THREADS=5 python main_bootstrap_arrest_time_only_train.py --prj_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_mecab_new_sc_bs_2way --scaling --save_dir /mnt/storage/personal/myhwang/119/experiments_results/Topic_model/tf_idf_mecab_new_sc_bs_2way --training --label 'label1' --mode '2way' --window_size 3 --method 'max'
